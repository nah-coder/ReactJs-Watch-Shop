          ...
          <div className="container">
            <div className="returning_customer">
              <div className="check_title">
                <h2>
                  Returning Customer?
                  <a href="/some-page">Click here to login</a>
                </h2>
              </div>
              <p>
              ...
              >
                ...
                <div className="col-md-12 form-group">
                  ...
                  <a className="lost_pass" href="/some-page">
                    Lost your password?
                  </a>
                </div>
              </form>
            ...
            <div className="cupon_area">
              <div className="check_title">
                <h2>
                  Have a coupon?
                  <a href="/some-page">Click here to enter your code</a>
                </h2>
              </div>
              <input type="text" placeholder="Enter coupon code" />
              <a className="tp_btn" href="/some-page">
                Apply Coupon
              </a>
            </div>
                ...
                <div className="col-lg-4">
                  <div className="order_box">
                    ...
                    <div className="creat_account">
                      ...
                      <a href="/some-page">terms &amp; conditions*</a>
                    </div>
                    <a className="btn_3" href="/some-page">
                      Proceed to Paypal
                    </a>
                  </div>
                </div>
